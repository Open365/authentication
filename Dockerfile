...
RUN apk update && apk add --no-cache curl make gcc g++ git python cairo pango bash \
    libjpeg giflib ttf-liberation krb5-dev && \
    ...
    ncurses-terminfo ncurses-libs readline sqlite-libs python bash krb5-dev && \
